import {
    ...
    Stack,
    Text,
    Image, Heading, ButtonGroup,Button,
    Badge, Icon,
    HStack,
    Avatar,
    useColorMode
...
<Text> Lorem ipsum dolor sit amet. Et corporis quisquam eum adipisci
            ...
            qui repudiandae voluptatem.</Text>
    </Stack>
            </ModalBody>
  
            <ModalFooter>
            <ButtonGroup spacing='2' width="100%">
      <Button variant='solid' onClick={onClose} colorScheme='blue' w="100%">
        Schedule
      </Button>
